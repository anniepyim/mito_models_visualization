...
query = 'SELECT target_exp.sampleID, target_exp.geneID, target_exp.log2, target_exp.pvalue, target_mut.mutation FROM target_exp LEFT JOIN target_mut ON target_exp.sampleID=target_mut.sampleID AND target_exp.geneID=target_mut.geneID WHERE target_exp.sampleID="' + sampleID+'" AND target_exp.userID in ("mitox","'+sessionid+'")'
